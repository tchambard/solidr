                        ...
                        {url && invitationToken && (
                            <>
                                <div className="w-full">
                                    <label htmlFor="generated-url" className="block text-sm font-medium text-zinc-700 dark:text-zinc-300">
                                    ...
                                    <div className="mt-1 flex rounded-md shadow-sm">
                                        ...
                                        <button
                                            ...
                                            className="inline-flex items-center px-3 rounded-r-md border border-zinc-300 bg-zinc-50 text-zinc-500 text-sm dark:bg-zinc-700 dark:border-zinc-600 dark:text-zinc-300"
                                        >
